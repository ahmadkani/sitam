...
export default function NewPost (props){
  ...
  const photoURL = values.user._id ?'/api/users/photo/'+ values.user._id : '/api/users/defaultphoto'
    return (<div className={classes.root}>
      ...
      <CardHeader
            avatar={
              <Avatar style={{margin:'5px'}} src={photoURL}/>
            }
      ...
      <CardActions>
        <Button color="primary" variant="contained" disabled={values.text === ''} onClick={clickPost} className={classes.submit}>ارسال</Button>
      </CardActions>
    </Card>
  </div>)
